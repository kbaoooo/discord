                ...
                <div className="flex flex-col w-full">
                    ...
                    {isImage && (
                        <a href={fileUrl} target="_blank"
                            rel="noreferrer"
                            className="relavtive aspect-square rounded-md mt-2 overflow-hidden border flex items-center bg-secondary h-48 w-48"
                        >
                    ...
                    {!fileUrl && !isEditing && (
                        <p className={cn(
                            ...
                            deleted && "italic text-zinc-500 dark:text-zinc-400 text-")}> 
                            {content}
                            {isUpdated && !deleted && (
                    ...
                    {canEditMessage && (
                        <ActionTooltip label="Edit">
                            <Edit 
                                ...
                                className="cursor-pointer h-4 w-4 text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300 transition ml-auto"
                            />
                        </ActionTooltip>
                    )}
                     <ActionTooltip label="Edit">
